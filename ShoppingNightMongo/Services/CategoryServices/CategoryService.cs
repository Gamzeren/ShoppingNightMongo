...
namespace ShoppingNightMongo.Services.CategoryServices
{
    public class CategoryService : ICategoryService
    {
        ...
        {
            var client=new MongoClient(_databaseSettings.ConnectionString); //bağlantı adresini al
            var database = client.GetDatabase(_databaseSettings.DatabaseName); //veritabanı adresini al
